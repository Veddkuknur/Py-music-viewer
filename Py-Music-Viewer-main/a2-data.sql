...
-- Data augmented by Anya Hanatuke, hanatuke@ualberta.ca

PRAGMA foreign_keys = ON;
--- Users ---
insert into users values ('1', 'Maheen Lynn', 'chord');
insert into users values ('2', 'Leena Markham',':CPa)<4jz89s`oM2');
insert into users values ('3', 'Branden Escobar','brag');
insert into users values ('4', 'Digby Tierney','rest');
insert into users values ('5', 'Harriet Beck','functional');
insert into users values ('6', 'Aron Gu','legislature');
insert into users values ('7', 'Jeevan Dillard','classroom');
insert into users values ('8', 'Laaibah Cano','tense');
insert into users values ('9', 'Ameila Pike','bomber');
insert into users values ('10','Davood Rafiei','fantasy');
insert into users values ('11', 'Spencer Schimdt','jury');
insert into users values ('12', 'Ryder Catonio','loot');
insert into users values ('13', 'Dradelli Guy','IFnG?o$~2W\LSN:>');
insert into users values ('14', 'Aron Gu','mosquito');
insert into users values ('15', 'Mark Sanchez','tape');
insert into users values ('16', 'Marion Trap','stem');
insert into users values ('17', 'Mackenzie Parks','crutch');
insert into users values ('18', 'Daria Blackburn', 'proper');
insert into users values ('19', 'Samuel Dixon','corner');
insert into users values ('20','Hamed Mirzaei','bronze');
insert into users values ('21', 'Amelia Pike','scheme');
insert into users values ('22', 'Quinn Mccartney','irony');
insert into users values ('23', 'Brenden Akhtar','monk');
insert into users values ('24', 'Catrina Maxwell','crew');
insert into users values ('25', 'Darsh Snyder','dressing');
insert into users values ('26', 'Pheobe Shannon','achieve');
insert into users values ('27', 'Judy Walsh','coalition');
insert into users values ('28', 'Bret Bartlett','/%s<7SqRP{z^fA7)');
insert into users values ('29', 'Diogo Lowry','week');
insert into users values ('30', 'Rudra Duke','soil');
insert into users values ('31', 'Mike Smith','mouse');
insert into users values ('32', 'Conner Wang','commemorate');
insert into users values ('33', 'Saim Hays','tenant');
insert into users values ('34', 'Jeanne Carlson','bold');
insert into users values ('35', 'John-Paul Whittaker','hunter');
insert into users values ('36', 'Bjorn Partridge','seat');
insert into users values ('37', 'Dominic Chen','worm');
insert into users values ('38', 'Aleah Mendoza','advertising');
insert into users values ('39', 'Kiyan Underwood','absence');
insert into users values ('40', 'Wendy Fernandez','effort');
insert into users values ('41', 'Shamima Gonzales','fantasy');
insert into users values ('42', 'Mike Smith','shop');
...
--- Sessions ---
-- September 2022
insert into sessions values ('10', 1, '2022-09-27', '2022-09-28');
insert into sessions values ('20', 1, '2022-09-25', '2022-09-27');
insert into sessions values ('3', 2, '2022-09-24', '2022-09-25');
insert into sessions values ('36', 3, '2022-09-24', '2022-09-25');
insert into sessions values ('1', 4, '2022-09-23', '2022-09-27');
insert into sessions values ('32', 5, '2022-09-22', '2022-09-24');
insert into sessions values ('23', 5, '2022-09-22', '2022-09-23');
insert into sessions values ('39', 6, '2022-09-16', '2022-09-18');
insert into sessions values ('32', 6, '2022-09-12', '2022-09-21');
insert into sessions values ('10', 7, '2022-09-13', '2022-09-16');
insert into sessions values ('22', 8, '2022-09-12', '2022-09-14');
insert into sessions values ('23', 9, '2022-09-08', '2022-09-15');
insert into sessions values ('15', 9, '2022-09-06', '2022-09-09');
insert into sessions values ('17', 10, '2022-09-02', '2022-09-04');

-- August 2022
insert into sessions values ('3', 10, '2022-08-25', '2022-08-28');
insert into sessions values ('7', 10, '2022-08-20', '2022-08-23');
insert into sessions values ('41', 11, '2022-08-22', '2022-08-26');

-- July 2022
insert into sessions values ('32', 11, '2022-07-19', '2022-07-23');
insert into sessions values ('28', 11, '2022-07-01', '2022-07-05');

-- June 2022
insert into sessions values ('9', 12, '2022-06-18', '2022-06-22');
insert into sessions values ('16', 13, '2022-06-16', '2020-06-18');
insert into sessions values ('23', 13, '2022-06-10', '2022-06-13');

-- May 2022
insert into sessions values ('26', 14, '2022-05-23', '2022-05-25');
insert into sessions values ('29', 14, '2022-05-27', '2022-05-31');
insert into sessions values ('35', 15, '2022-05-20', '2022-05-23');
insert into sessions values ('23', 15, '2022-05-10', '2022-05-14');

-- April 2022
insert into sessions values ('33', 16, '2022-04-28', '2022-04-30');
insert into sessions values ('19', 17, '2022-04-15', '2022-04-18');
insert into sessions values ('8', 17, '2022-04-02', '2022-04-05');

-- March 2022
insert into sessions values ('8', 18, '2022-03-25', '2022-03-28');
insert into sessions values ('14', 19, '2022-03-07', '2022-03-11');

-- February 2022
insert into sessions values ('1', 20, '2022-02-23', '2022-02-26');
insert into sessions values ('5', 20, '2022-02-17', '2022-02-20');
insert into sessions values ('9', 20, '2022-02-08', '2022-02-11');
insert into sessions values ('11', 20, '2022-02-02', '2022-02-05');

-- January 2022
insert into sessions values ('10', 21, '2022-01-28', '2022-01-31');
insert into sessions values ('6', 21, '2022-01-25', '2022-01-28');
insert into sessions values ('9', 21, '2022-01-22', '2022-01-25');
insert into sessions values ('13', 22, '2022-01-19', '2022-01-21');

-- December 2021
insert into sessions values ('19', 22, '2021-12-31', '2022-01-02');
insert into sessions values ('17', 22, '2021-12-20', '2021-12-25');
insert into sessions values ('27', 22, '2021-12-16', '2021-12-20');

-- November 2021
insert into sessions values ('11', 23, '2021-11-18', '2021-11-22');
insert into sessions values ('4', 23, '2021-11-17', '2021-11-19');
insert into sessions values ('42', 23, '2021-11-16', '2021-11-18');

-- October 2021
insert into sessions values ('2', 24, '2021-10-30', '2021-11-03');
insert into sessions values ('11', 24, '2021-10-27', '2021-10-30');
insert into sessions values ('38', 24, '2021-10-24', '2021-10-27');
...
--- Artists ---
insert into artists values ('a1', 'Lady Gaga', 'United States','east');
insert into artists values ('a2', 'OneRepublic', 'United States','slam');
insert into artists values ('a3', 'Imagine Dragons', 'United States','appearance');
insert into artists values ('a4', 'PSY', 'South Korea','complex');
insert into artists values ('a5', 'P!nk', 'American','company');
insert into artists values ('a6', 'Nate Reuss', 'American','past');
insert into artists values ('a7', 'Kelly Clarkson', 'United States','introduction');
insert into artists values ('a8', 'Janelle Monáe', 'United States','way');
insert into artists values ('a9', 'Maroon 5', 'United States','fill');
insert into artists values ('a10', 'Drake', 'Canada','twist');
insert into artists values ('a11', 'Pitbull', 'American','glare');
insert into artists values ('a12', 'Sia', 'Australian','sentiment');
insert into artists values ('a13', 'Neon Trees', 'American','encourage');
insert into artists values ('a14', 'Carly Rae Jepsen', 'Canada','slam');
insert into artists values ('a15', 'Calvin Harris', 'Scotland','stretch');
insert into artists values ('a16', 'Ellie Goulding', 'United Kingdom','key');
insert into artists values ('a17', 'Avicii', 'Swedish','deteriorate');
insert into artists values ('a18', 'Sean Paul', 'Jamaica','coffin');
insert into artists values ('a19', 'David Guetta', 'French','guitar');
insert into artists values ('a20', 'Bob Ezrin', 'Canadian','receipt');
insert into artists values ('a21', 'Echosmith', 'American','potential');
insert into artists values ('a22', 'The Wanted', 'British','regular');
insert into artists values ('a23', 'Selena Gomez', 'United States','missile');
insert into artists values ('a24', 'Rixton', 'British','inspector');
insert into artists values ('a25', 'American Authors', 'American','crossing');
insert into artists values ('a26', 'Cobra Starship', 'American','`;{Sz8hIV<OZ`WA!');
insert into artists values ('a27', 'Captial Cities', 'American','planet');
insert into artists values ('a28', 'WALK THE MOON', 'United States','conscious');
insert into artists values ('a29', 'Jason Derulo', 'American','review');
insert into artists values ('a30', 'Taio Cruz', 'English','collapse');
insert into artists values ('a31', 'The Script', 'Ireland','paint');
insert into artists values ('a32', 'Jennifer Lopez', 'American','sleep');
insert into artists values ('a33', 'Shakira', 'Colombia','decade');
insert into artists values ('a34', 'The Weeknd', 'Canada','glimpse');
insert into artists values ('a35', 'Celine Dion', 'Canada','hunter');
insert into artists values ('a36', 'Avril Lavigne', 'Canadian','commerce');
insert into artists values ('a37', 'Flo Rida', 'American','certain');
insert into artists values ('a38', 'Spice Girls', 'British','[E#b90}^Dea$LxZl');
insert into artists values ('a39', 'Ed Sheeran', 'England','confusion');
